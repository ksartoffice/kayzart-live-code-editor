...
PROMPT;
	...
	private static function editor_mode_rules( string $intent, string $editor_mode ): string {
		...
		$lines = array(
			...
			'- Never add a plain CSS rule such as `.btn { ... }` or `#hero p { ... }` to the CSS tab. Rules written outside the Tailwind system ignore @theme tokens and conflict with the utility classes on the page. Such an edit is rejected.',
