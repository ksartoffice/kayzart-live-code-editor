...
class Ai_Tool_Schema {
	 ...
	 * edit and has nowhere else to go. What to write in the CSS tab is stated in
	 * the Tailwind mode rules of the system prompt instead, which is where the
	 * guidance was missing all along: the old rules only said to prefer HTML and
	 * to leave CSS alone, never what belongs in CSS once it is edited.
	 *
