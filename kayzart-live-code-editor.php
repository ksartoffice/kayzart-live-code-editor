...
require_once KAYZART_PATH . 'includes/ai/class-kayzart-ai-tailwind-css-policy.php';
...
require_once KAYZART_PATH . 'includes/rest/class-kayzart-rest-ai-prompt.php';
